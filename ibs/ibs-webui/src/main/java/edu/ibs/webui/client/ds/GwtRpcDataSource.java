package edu.ibs.webui.client.ds;
 ...
 * @version 1.0
 */
public class GwtRpcDataSource extends DataSource {
     ...
     * @param dsRequest  ������
     */
    public void addData(final Record record, final DSCallback dsCallback, final DSRequest dsRequest) {
    }
